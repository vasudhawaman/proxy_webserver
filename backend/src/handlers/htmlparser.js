function detectMaliciousCode(htmlContent) {
    ...
    countPatterns(scriptPatterns, 'scriptInjection', 'Suspicious JavaScript injection');
    ...
    countPatterns(dataExfiltrationPatterns, 'dataExfiltration', 'Data exfiltration patterns');
    countPatterns(clickjackingPatterns, 'clickjacking', 'Clickjacking indicators');
    countPatterns(suspiciousAttributes, 'suspiciousAttributes', 'Suspicious HTML attributes');
